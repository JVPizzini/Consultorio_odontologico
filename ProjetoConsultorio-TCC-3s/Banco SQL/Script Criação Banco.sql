...
Constraint fk_CodEstado Foreign Key (CodEstado) References Estado(CodEstado)
)
...
Ativo       bit          Not Null   ,
Constraint fk_CodCidadeCliente Foreign Key (CodCidade) References Cidade(CodCidade),
Constraint fk_CodEstadoCliente Foreign Key (CodEstado) References Estado(CodEstado),
...
Estado	    varchar(100) Not Null   ,
Ativo       bit          Not Null   ,
Constraint fk_CodCidadeFuncionario Foreign Key (CodCidade) References Cidade(CodCidade),
Constraint fk_CodEstadoFuncionario Foreign Key (CodEstado) References Estado(CodEstado),
Constraint un_CPFFuncionario Unique(CPF)
)

Create Table Profissionais(
CodProfis   int primary key identity,
Nome	      varchar(100) Not Null   ,
CPF	        varchar(14)  Not Null   ,
Nascimento  date	       Not Null   ,
...
Observacao  varchar(max)            ,
Ativo       bit          Not Null   ,
Constraint fk_CodCidadeProfis Foreign Key (CodCidade) References Cidade(CodCidade),
Constraint fk_CodEstadoProfis Foreign Key (CodEstado) References Estado(CodEstado),
Constraint un_CPFProfis Unique(CPF)
)
...
CodServico int primary key identity,
...
Data          date Not Null,
CodHorarioIni int	 Not Null,
HorarioIni    time Not Null,
CodHorarioFim int  Not Null,
HorarioFim    time Not Null,
CodFuncInc    int  Not Null,
DtInclusao    datetime default GetDate(),
Status        char         ,
CodFuncCanc   int          ,
DtCancel      datetime     ,
MotivoCanc    varchar(max) ,
Constraint fk_ConsultaProfis	       Foreign Key (CodProfis)     References Profissionais(CodProfis),
Constraint fk_ConsultaCliente	       Foreign Key (CodCliente)    References Clientes(CodCliente),
Constraint fk_ConsultaServico	       Foreign Key (CodServico)    References Servicos(CodServico),
Constraint fk_ConsultaCodHorarioIni  Foreign Key (CodHorarioIni) References Horarios(CodHorario),
Constraint fk_ConsultaCodHorarioFim  Foreign Key (CodHorarioFim) References Horarios(CodHorario),
Constraint fk_ConsultaCodFuncInc     Foreign Key (CodFuncInc)    References Funcionarios(CodFunc),
Constraint fk_ConsultaCodFuncCanc    Foreign Key (CodFuncCanc)   References Funcionarios(CodFunc)
)

------------------------------------------------------------------------------------------------
--CÓDIGO PARA INSERIR DADOS NAS TABELAS

Insert Into Estado(CodEstado, Nome, UF) Values
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
Insert Into Cidade(CodCidade, Nome, CodEstado) Values
(1, 'Afonso Cláudio', 8),
...
Insert Into Servicos(Descricao) Values ('Limpeza completa'),('Clareamento a laser'),('Clareamento a gel'),('Colocar aparelho')

Insert Into Profissionais(Nome, CPF, Nascimento, CRO, Tel1, CEP, Rua, Numero, Bairro, CodCidade, Cidade, CodEstado, Estado, Ativo) Values 
('Lucas Carmelim','459.099.990-45','1997-07-19','12345/SP','18997557000','16.200-348','Rua Particular','50','São Vicente',4779,'Birigui',26,'SP',1),
('João Pizini','147.047.012-34','1994-02-22','19974/SP','18997384987','16.200-341','Rua Barão do Rio Branco','1479','Centro',4779,'Birigui',26,'SP',1),
('Lucas Borges','203.478.978-10','2000-12-15','7891/MG','1836433537','16.400-123','Rua Santos Dumont','205','Ipanema',4737,'Araçatuba',26,'SP',1),
('Vinicius Vacare','303.459.078-49','1996-08-14','85234/SP','1836003600','17.801-471','Rua Euclides','4101','Novo Mundo',5132,'Piacatu',26,'SP',1),
('Bruno Teles','014.693.357-74','1992-04-29','98745/SP','1832110422','16.200-471','Rua Doze','487','Centro',4778,'Bilac',26,'SP',1)

Insert into Funcionarios(Nome,CPF,Senha,Tel1,CEP,Rua,Numero,Bairro,CodCidade,Cidade,CodEstado,Estado,Ativo) Values
('Ana Carolina Pereira','047.147.210-14','N0target','1830217525','16.041-80','Rua Doutor José',2223,'Jardim Vicente',4779,'Birigui',26,'SP',1),
('Claudia Vicentine','007.847.687-10','senhaTeste','18997557070','16.021-10','Rua Sete',1974,'Centro',4779,'Birigui',26,'SP',1)

Insert into Clientes(Nome,CPF,Nascimento,Tel1,CEP,Rua,Numero,Bairro,CodCidade,Cidade,CodEstado,Estado,Email,Ativo) Values 
('Bruna da Silva','123.456.789-10','1997-01-19','1832010101','16.041-87','Rua Saudades',354,'Jardim Perdizes',4779,'Birigui',26,'SP','bruna@hotmail.com',1),
('Tiago Junqueira','041.874.123-07','1990-09-22','1832018784','20.041-87','Rua Onze',12,'Centro',4737,'Araçatuba',26,'SP','tiagojunqueira@gmail.com',1),
('Maria Carmelim','851.032.123-96','1986-07-24','1834340101','16.040-99','Rua Wilson Troncoso',255,'Jardim do Morro',4779,'Birigui',26,'SP','mariacarmelim@gmail.com',1),
('Josefina dos Santos','123.099.147-80','1960-01-01','1834340303','14.000-00','Rua do Centro',9941,'Campo Belo',4779,'Birigui',26,'SP','josefina@gmail.com',1),
('João Carlos Ferreira','003.874.961-96','2000-11-30','1830210201','16.020-10','Rua João Bento',657,'Centro',4779,'Birigui',26,'SP','joao_carlos@gmail.com',1)

Insert into Horarios (CodHorario,Horario,Ativo) Values 
(1 ,'06:00:00.0000000', 1),
(2 ,'06:30:00.0000000', 1),
(3 ,'07:00:00.0000000', 1),
(4 ,'07:30:00.0000000', 1),
(5 ,'08:00:00.0000000', 1),
(6 ,'08:30:00.0000000', 1),
(7 ,'09:00:00.0000000', 1),
(8 ,'09:30:00.0000000', 1),
(9 ,'10:00:00.0000000', 1),
(10,'10:30:00.0000000', 1),
(11,'11:00:00.0000000', 1),
(12,'11:30:00.0000000', 1),
(13,'12:00:00.0000000', 1),
(14,'12:30:00.0000000', 1),
(15,'13:00:00.0000000', 1),
(16,'13:30:00.0000000', 1),
(17,'14:00:00.0000000', 1),
(18,'14:30:00.0000000', 1),
(19,'15:00:00.0000000', 1),
(20,'15:30:00.0000000', 1),
(21,'16:00:00.0000000', 1),
(22,'16:30:00.0000000', 1),
(23,'17:00:00.0000000', 1),
(24,'17:30:00.0000000', 1),
(25,'18:00:00.0000000', 1),
(26,'18:30:00.0000000', 1),
(27,'19:00:00.0000000', 1),
(28,'19:30:00.0000000', 1)


Insert into Consultas(CodProfis, CodCliente, CodServico, Data, CodHorarioIni, HorarioIni, CodHorarioFim, HorarioFim, Status, CodFuncInc) Values
(1,1,1,'2020-04-23',6, '08:30:00.0000000',7, '09:00:00.0000000','A', 1),
(2,2,2,'2020-04-23',7, '09:00:00.0000000',8, '09:30:00.0000000','A', 1),
(3,3,3,'2020-04-23',11,'11:00:00.0000000',13,'12:00:00.0000000','A', 2),
(4,4,4,'2020-04-23',19,'15:00:00.0000000',22,'16:30:00.0000000','A', 2),
(5,5,1,'2020-04-23',9, '10:00:00.0000000',10,'10:30:00.0000000','A', 1),
(1,5,3,'2020-04-26',5, '08:00:00.0000000',6, '08:30:00.0000000','A', 2),
(2,4,1,'2020-04-24',1, '06:00:00.0000000',3, '07:00:00.0000000','A', 2),
(3,3,2,'2020-04-24',15,'13:00:00.0000000',16,'13:30:00.0000000','A', 1),
(4,2,4,'2020-04-23',18,'14:30:00.0000000',19,'15:00:00.0000000','A', 1),
(5,1,2,'2020-04-25',9, '10:00:00.0000000',10,'10:30:00.0000000','A', 1)
